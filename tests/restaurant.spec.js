...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    assert.deepStrictEqual(createMenu({ food: { coxinha: 3.9, sanduiche: 9.9 } }).fetchMenu(), {
    ...
    // ```
    const objetoTeste = createMenu({ food: { coxinha: 4 }, drink: { agua: 3 } });
    assert.deepStrictEqual(objetoTeste.consumption, []);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    objetoTeste.order('coxinha');
    assert.deepStrictEqual(objetoTeste.consumption, ['coxinha']);
    // const objetoRetornado = createMenu(objetoQualquer);
    ...
    // ```
    objetoTeste.order('agua');
    objetoTeste.order('sopa');
    objetoTeste.order('sashimi');

    assert.deepStrictEqual(objetoTeste.consumption, ['coxinha', 'agua', 'sopa', 'sashimi']);
    ...
    const objetoTeste2 = createMenu({ food: { coxinha: 3.5 }, drink: { agua: 3 } });
    objetoTeste2.order('coxinha');
    objetoTeste2.order('agua');

    assert.strictEqual(objetoTeste2.pay(), 6.5);
    // ```
