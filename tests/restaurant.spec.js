...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(typeof(objetoRetornado), typeof({fetchMenu: () => {},}));
    // ```
    ...
    const result = objetoRetornado.fetchMenu() // Retorno: { food: {}, drink: {}}
    assert.deepStrictEqual(Object.keys(result), ['food', 'drink']);
    ...
    objetoRetornado2.consumption // Retorno: ["coxinha"]
    ...
    objetoRetornado3.consumption // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    ...
    objetoRetornado4.order('coxinha');
    objetoRetornado4.comsuption // Retorno: ['coxinha', 'agua', 'coxinha']
    ...
    const totalValue = createMenu(newOrder);
    totalValue.order('coxinha');
    totalValue.order('agua');
    totalValue.order('coxinha');
    assert.strictEqual(totalValue.pay(), 13);
