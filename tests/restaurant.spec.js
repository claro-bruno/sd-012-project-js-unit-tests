...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    objetoRetornado1.fetchMenu() // Retorno: { food: {}, drink: {}}
    assert.deepStrictEqual(typeof objetoRetornado1.fetchMenu() === 'object' && objetoRetornado.fetchMenu.keys('food', 'drink'), true);
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado2, objetoRetornado2.fetchMenu());
    // ```
