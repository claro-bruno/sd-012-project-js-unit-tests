...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.notStrictEqual(typeof createMenu({food: {}, drink:{}}).fetchMenu({food: {}, drink:{}}).food, 'undefined');
    assert.notStrictEqual(typeof createMenu({food: {}, drink:{}}).fetchMenu({food: {}, drink:{}}).drink, 'undefined');
    // ```
