...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const chaveMenu = objetoRetornado2.fetchMenu();
    assert.deepStrictEqual(Object.keys(chaveMenu), ['food', 'drink']);
    ...
    // ```
    const objetoRetornado3 = createMenu({ food: {sopa: 21.90}, drink: {agua: 3.50}});
    const chaveMenu2 = objetoRetornado3.fetchMenu();
    assert.deepStrictEqual(chaveMenu2, { food: {sopa: 21.90}, drink: {agua: 3.50}});
    ...
    assert.deepStrictEqual(Object.values(objetoRetornado6.consumption), ['coxinha', 'sopa', 'água']);
