...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(typeof(objetoRetornado1), 'object');
    ...
    assert.deepStrictEqual(objetoRetornado3.fetchMenu(), { food: 'coxinha', drink: 'suco'});
    ...
    // ``` 
    const objetoRetornado4 = createMenu({ food: 'coxinha', drink: 'suco'});
    ...
    // ```
    const objetoRetornado5 = createMenu(({ food: 'coxinha', drink: 'suco'}));
    ...
    // ```
    const objetoRetornado6 = createMenu({ food: {'coxinha': 3.9, 'sashimi': 9.9}, drink: {'agua': 3.9, 'sopa': 6.9} });
    ...
    // ```
    const objetoRetornado7 = createMenu({ food: {'coxinha': 3.9, 'sashimi': 9.9}, drink: {'agua': 3.9, 'sopa': 6.9} });
