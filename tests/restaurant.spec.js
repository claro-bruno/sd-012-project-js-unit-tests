...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    assert.strictEqual(createMenu().hasOwnProperty('fetchMenu'), true);
    ...
    // ```
    let returnedObject = createMenu({
      food: {},
      drinks: {}
    });
    assert.deepStrictEqual(returnedObject.fetchMenu(), {
      food: {},
      drinks: {}
    });
    ...
    returnedObject = createMenu(objectInput);
    assert.deepStrictEqual(returnedObject.fetchMenu(), objectInput);
    ...
    // ```
    assert.strictEqual(returnedObject.pay(), 12.87);
