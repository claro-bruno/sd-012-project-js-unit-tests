...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    // ```
    let objectIn = { food: {}, drink: {} };
    let objetoRetornado = createMenu(objectIn)
    
    assert.deepStrictEqual(Object.keys(objetoRetornado.fetchMenu()), Object.keys(objectIn));
    ...
    // ```
    objectIn = {
      food: {'coxinha': 1.1, 'sashimi': 2.10},
      drinks: {'agua': 3.90, 'cerveja': 4.90},
    };
    objetoRetornado = createMenu(objectIn);
    assert.deepStrictEqual(objetoRetornado.fetchMenu(), objectIn);
    ...
    objetoRetornado.order("coxinha");
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "cerveja", 'coxinha']); // Retorno: 
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado.consumption, ["coxinha", "agua", "cerveja", "coxinha", "agua"]); // Retorno: []
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado.pay(), 16.39)
    // objetoRetornado.order('coxinha');
    // objetoRetornado.order('agua');
    // objetoRetornado.order('coxinha');
