...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    assert.strictEqual('fetchMenu' in objetoRetornado1, true);
    assert.strictEqual(typeof objetoRetornado1.fetchMenu === 'function', true);
    // ```
   ...
   // ```
    ...
    assert.strictEqual(objetoRetornado5.order('coxinha'), objetoRetornado5.consumption);
    // ```
    ...
    assert.deepStrictEqual(objetoRetornado6.consumption, [ 'coxinha', 'agua', 'sopa', 'sashimi' ]); // Retorno: ["coxinha", "agua", "sopa", "sashimi"]
    // ```
