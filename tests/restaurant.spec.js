...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const meuRestaurante = createMenu(items)
    ...
    assert.deepStrictEqual(Object.keys(meuRestaurante.fetchMenu()), ['food', 'drink'])
    
    // TESTE 3: Verifique que o menu passado pra função createMenu é identico ao menu recuperado pela função 'objetoRetornado.fetchMenu'
    // ```
    // const objetoRetornado = createMenu(objetoQualquer);
    // objetoRetornado.fetchMenu() // Retorno: objetoQualquer
    assert.deepStrictEqual(meuRestaurante.fetchMenu(), items)
    ...
    assert.deepStrictEqual(meuRestaurante.consumption, ['coxinha', 'agua', 'sanduiche', 'cerveja'])
    ...
    // ```
    meuRestaurante.order('coxinha')
    assert.deepStrictEqual(meuRestaurante.consumption, ['coxinha', 'agua', 'sanduiche', 'cerveja', 'coxinha'])
    ...
    // ```
  assert.strictEqual(meuRestaurante.pay(), 42.3)
