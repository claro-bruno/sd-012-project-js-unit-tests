...
describe('9 - Implemente os casos de teste e a função `createMenu`', () => {
  it('Verifica se a função `createMenu` tem o comportamento esperado', () => {
    ...
    const objetoRetornado = createMenu(objetoQualquer); // Retorno: { fetchMenu: () => {}, ... }
    assert.strictEqual('fetchMenu' in objetoRetornado, true);
    assert.strictEqual(typeof objetoRetornado.fetchMenu === 'function', true);
    // ```
   ...
   // ```
    ...
    assert.strictEqual(objetoRetornado.order('coxinha'), objetoRetornado.consumption);
    // ```
