...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(productDetails()[0].details.productId === productDetails()[0].name + `123`, true);
    assert.strictEqual(productDetails()[1].details.productId === productDetails()[1].name + `123`, true);
  });
});
