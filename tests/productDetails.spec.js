...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    let id1 = productDetails('Alcool gel', 'Máscara')[0].details.productId;
    let id2 = productDetails('Alcool gel', 'Máscara')[1].details.productId;
    assert.strictEqual(
      id1.substring(id1.length - 3, id1.length) && id2.substring(id2.length - 3, id2.length),
      '123'
    );
  });
});
