...
<<<<<<< HEAD
    // let arr = productDetails('Alcool gel', 'Máscara');
    // assert.strictEqual(arr.every((item) => { item.details.productId.substr(-3) }), true);
=======
    // Teste que os dois productIds terminam com 123.
>>>>>>> b07b07cd0a9a79d4bdf6e310963e23ad65f4b56b
  });
});
