...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.strictEqual(productDetails('Mascara', 'Luva').some(elem => typeof elem === 'object'), true);// Teste que os dois itens dentro do array retornado pela função são objetos.

    assert.notDeepStrictEqual(productDetails('Mascara', 'Luva')[0], productDetails('Mascara', 'Luva')[1]);// Teste que os dois objetos são diferentes entre si.
