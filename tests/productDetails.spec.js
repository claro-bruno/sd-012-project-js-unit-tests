...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.notDeepStrictEqual(productDetails(('Alcool gel', 'Máscara'))[0].name, productDetails(('Alcool gel', 'Máscara'))[1].name);
    ...
    /* fonte: https://developer.mozilla.org/pt-BR/docs/Web/JavaScript/Reference/Global_Objects/Array/slice */
  });
});
