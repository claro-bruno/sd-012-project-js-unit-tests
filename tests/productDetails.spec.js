...
describe('6 - Implemente os casos de teste para a função `productDetails`', () => {
  it('Verifica se a função `productDetails` tem o comportamento esperado', () => {
    ...
    assert.ok(productDetails('string1', 'string2')[0] !== productDetails('string1', 'string2')[1]);
    // (Difícil) Teste que os dois productIds terminam com 123.
    assert.ok(productDetails('string1', 'string2')[0].details.productId === 'string1123');
    assert.ok(productDetails('string1', 'string2')[1].details.productId === 'string2123');
  });
});
