...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {    
    ...
    const testCircle1 = circle();
    assert.deepStrictEqual(testCircle1, undefined);
    ...
    const testCircle2 = circle(3);
    assert.deepStrictEqual(testCircle2, { area: 28.259999999999998, circumference: 18.84, radius: 3 });
  });
});
