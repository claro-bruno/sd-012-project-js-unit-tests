...
describe('4 - Implemente os casos de teste para a função `circle`', () => {
  it('Verifica se ao receber um raio, a função `circle` retorna um objeto contedos os valores esperados', () => {
    ...
    assert.notStrictEqual(circle(9), null);
    assert.notStrictEqual(Array.isArray(circle(9)), true);
    ...
    assert.deepStrictEqual(circle(3), {radius: 3, area: 3 * 3.14 * 3, circumference: 2 * 3.14 * 3});
  });
});
